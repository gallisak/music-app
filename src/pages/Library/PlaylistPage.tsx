...
export function PlaylistPage() {
  ...
  if (!playlist) {
    return (
      <div className="pt-24 pl-4 lg:pl-64 text-white text-2xl font-bold flex justify-center items-center h-screen">
        Playlist not found
      </div>
    );
  }
  ...
  return (
    <div className="pt-24 pl-4 lg:pl-60 lg:pr-60 pr-4 min-h-screen bg-white dark:bg-[#121212] transition-colors duration-300">
          ...
          playlist.tracks.map((track) => (
            <div key={track.id} className="relative group">
              ...
              <button
                ...
                className="absolute top-1 right-1 z-10 bg-red-500 hover:bg-red-600 text-white rounded-full w-7 h-7 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all shadow-lg cursor-pointer"
